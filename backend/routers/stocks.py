...
async def get_stock_history(
    ...
    try:
        ...
        if interval == "15m" or interval == "1h" or interval == "1m" or interval == "5m":
...
async def get_financials(symbol: str) -> Dict:
    try:
        ...
        financials = {
            "income_statement": income_stmt.fillna(0).to_dict() if not income_stmt.empty else {},
            "balance_sheet": balance_sheet.fillna(0).to_dict() if not balance_sheet.empty else {},
