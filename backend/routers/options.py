    ...
    try:
        ...
        for expiry in expiries:
            for strike in strikes:
                call_price = black_scholes(stock_price, strike, expiry, risk_free_rate, volatility, "call")
                put_price = black_scholes(stock_price, strike, expiry, risk_free_rate, volatility, "put")
        ...
        raise HTTPException(status_code=500, detail=f"Error generating volatility surface: {str(e)}")